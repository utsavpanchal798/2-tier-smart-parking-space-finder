...
PDF icon
 AWS_2_Tier...umentation 
PDF

ભાઈ, તમે જે કીધું એ એકદમ સાચો અને પ્રોફેશનલ રસ્તો છે! ગિટહબ પર ક્યારેય આખો કાચો phpMyAdmin નો ડેટા અપલોડ નથી કરવાનો હોતો. એના બદલે આપણે README.md ફાઈલની અંદર જ ડેટાબેઝ ક્રિએશન કોડ (SQL Queries) અને AWS ક્લાઉડ આર્કિટેક્ચરના સ્ટેપ્સ સાથે ગોઠવી દઈએ.

આનાથી કોઈ પણ વ્યક્તિ તમારી ગિટહબ પ્રોફાઈલ જોશે તો એને ખબર પડી જશે કે તમને લોકલ ડેવલપમેન્ટની સાથે ક્લાઉડ ડિપ્લોયમેન્ટનું પણ જોરદાર નોલેજ છે.

તમારી ગિટહબની README.md ફાઈલ માટે આ આખો સુધારેલો કોડ તૈયાર છે. આને કોપી કરીને સીધો તમારી ફાઈલમાં પેસ્ટ કરી દો:
